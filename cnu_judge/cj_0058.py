...
standardization_lambda = lambda x: (x-x.mean()) / x.std()


if __name__ == "__main__":
    arr1 = np.array([1, 2, 3, 4, 5])
    print(standardization(arr1))

    arr2 = np.array([100, 0])
    print(standardization(arr2))

    print("-" * 20)

    arr1 = np.array([1, 2, 3, 4, 5])
    print(standardization_lambda(arr1))

    arr2 = np.array([100, 0])
    print(standardization_lambda(arr2))